          ...
          if (_this2.language) {
            return _invokeIgnored(function () {
              if (d_languages.includes(_this2.language)) {
                Prism.highlightAllUnder(_this2.$refs.codeBlock);
              } else {
...
var __vue_component__$f = /*#__PURE__*/__vue_normalize__({}, __vue_inject_styles__$f, __vue_script__$f, __vue_scope_id__$f, __vue_is_functional_template__$f, __vue_module_identifier__$f, false, undefined, undefined, undefined);
...
var __vue_component__$g = /*#__PURE__*/__vue_normalize__({}, __vue_inject_styles__$g, __vue_script__$g, __vue_scope_id__$g, __vue_is_functional_template__$g, __vue_module_identifier__$g, false, undefined, undefined, undefined);
...
var index = {
  install: function install(Vue, app_options) {
    ...
    var options = merge(def_options, app_options);
...
export { __vue_component__$b as FAlert, __vue_component__$8 as FButton, __vue_component__$a as FCode, __vue_component__$1 as FContent, __vue_component__$4 as FFooter, __vue_component__$d as FFormSelect, __vue_component__$2 as FHeader, __vue_component__ as FIcon, __vue_component__$7 as FLink, __vue_component__$h as FList, __vue_component__$c as FLoading, __vue_component__$g as FMarkdown, __vue_component__$3 as FNavbar, __vue_component__$9 as FPagination, __vue_component__$e as FTab, __vue_component__$f as FTabs };
